-- Simple Admin Schema Fix
-- This script adds missing columns to admin tables without complex PL/pgSQL
...
DO $$
BEGIN
  -- Check if prompt column already exists and what type it is
  IF EXISTS (
    ...
    ELSE
      -- It's text type, convert to jsonb
...
-- Add prompt column to rulesets table
DO $$
BEGIN
  IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_name = 'rulesets' AND table_schema = 'public') THEN
    -- Check if prompt column already exists and what type it is
...
-- ============================================================================
-- ADD MISSING COLUMNS TO ENTRIES TABLE (if it exists)
-- ============================================================================

-- Add slug column to entries table
DO $$
BEGIN
...
-- Add prompt column to entries table
DO $$
BEGIN
  IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_name = 'entries' AND table_schema = 'public') THEN
    -- Check if prompt column already exists and what type it is
...
-- ============================================================================
-- ADD MISSING COLUMNS TO ENTRY_POINTS TABLE (if it exists)
-- ============================================================================

-- Add slug column to entry_points table
DO $$
BEGIN
...
-- Add prompt column to entry_points table
DO $$
BEGIN
  IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_name = 'entry_points' AND table_schema = 'public') THEN
    -- Check if prompt column already exists and what type it is
...
-- ============================================================================
-- ADD MISSING COLUMNS TO NPC_PACKS TABLE (if it exists)
-- ============================================================================

-- Add slug column to npc_packs table
DO $$
BEGIN

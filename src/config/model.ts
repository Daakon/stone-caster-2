// src/config/model.ts
// Central runtime config for Gemini-only model provider
// Validates required env vars and exports frozen config object

import 'dotenv/config';

/**
 * Helper to require an environment variable
 * Throws descriptive error if missing or set to placeholder
 */
...
// Validate provider is Gemini-only
...
/**
 * Model configuration - validated and frozen
 * Used by Gemini adapter in Phase 1
 */

-- Test Admin Tables (Fixed for world_id constraint)
...
-- Test creating an entry and entry point with proper world_id
DO $$
DECLARE
  world_count integer;
  test_world_id text;
...
BEGIN
  ...
  -- Create test entry point with proper world_id

-- Test Admin Tables (Fixed for correct content_rating values)
...
BEGIN
  ...
  -- Create test entry point with valid content_rating ('safe', 'mature', or 'explicit')
  ...
  VALUES (
    ...
    'safe',  -- Use 'safe' (valid value: 'safe', 'mature', or 'explicit')
    'active', 

-- ============================================================================
-- POSTGRESQL-COMPATIBLE MIGRATION - FINAL VERSION
-- ============================================================================
-- This version ensures all columns exist before creating indexes
...
-- ============================================================================
-- STEP 9: ENSURE NPCS HAS ALL REQUIRED COLUMNS (ADD IF MISSING)
-- ============================================================================
...
BEGIN
  IF NOT EXISTS (
    ...
    RAISE NOTICE 'Added name column to npcs table';
  ELSE
    RAISE NOTICE 'Name column already exists in npcs table';
  END IF;
EXCEPTION
  WHEN duplicate_column THEN
    RAISE NOTICE 'Name column already exists (caught exception)';
...
BEGIN
  IF NOT EXISTS (
    ...
    RAISE NOTICE 'Added description column to npcs table';
  ELSE
    RAISE NOTICE 'Description column already exists in npcs table';
  END IF;
EXCEPTION
  WHEN duplicate_column THEN
    RAISE NOTICE 'Description column already exists (caught exception)';
...
BEGIN
  IF NOT EXISTS (
    ...
    RAISE NOTICE 'Added status column to npcs table';
  ELSE
    RAISE NOTICE 'Status column already exists in npcs table';
  END IF;
EXCEPTION
  WHEN duplicate_column THEN
    RAISE NOTICE 'Status column already exists (caught exception)';
...
BEGIN
  IF NOT EXISTS (
    ...
    RAISE NOTICE 'Added created_at column to npcs table';
  ELSE
    RAISE NOTICE 'Created_at column already exists in npcs table';
  END IF;
EXCEPTION
  WHEN duplicate_column THEN
    RAISE NOTICE 'Created_at column already exists (caught exception)';
END $$;
...
BEGIN
  IF NOT EXISTS (
    ...
    RAISE NOTICE 'Added updated_at column to npcs table';
  ELSE
    RAISE NOTICE 'Updated_at column already exists in npcs table';
  END IF;
EXCEPTION
  WHEN duplicate_column THEN
    RAISE NOTICE 'Updated_at column already exists (caught exception)';
END $$;

-- ============================================================================
-- STEP 10: CREATE INDEX ON NPCS STATUS (ONLY AFTER COLUMN EXISTS)
-- ============================================================================

-- Create index AFTER ensuring the status column exists
DO $$
BEGIN
  IF NOT EXISTS (
    SELECT 1 FROM pg_indexes 
    ...
    RAISE NOTICE 'Created npcs_status_idx index';
  ELSE
    RAISE NOTICE 'npcs_status_idx index already exists';
  END IF;
END $$;
...
-- ============================================================================
-- STEP 11: ADD PROMPT COLUMN TO RULESETS
-- ============================================================================
...
-- ============================================================================
-- STEP 12: ADD PROMPT COLUMN TO NPCS
-- ============================================================================
...
-- Let's verify what columns now exist in the npcs table
DO $$
DECLARE
  col_record RECORD;
BEGIN
  RAISE NOTICE 'Current columns in npcs table:';
  FOR col_record IN 
